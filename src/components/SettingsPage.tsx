...
const LOCALE_OPTIONS: { id: Locale; labelKey: "settings.locale.zhCN" | "settings.locale.en" | "settings.locale.zhTW" }[] =
  [
  ...
  return (
    <div className="page settings-page">
      <header className="page-header">
        ...
        <span className="badge badge-mock">{t("settings.pickerBadge")}</span>
      </header>
        ...
        <div className="settings-card">
          <div className="settings-row">
            <div className="settings-row-main">
              <div className="stat-label">{t("settings.currentPath")}</div>
              <div className="mono wrap" title={workspace.path}>
                {workspace.path}
              </div>
              <div className="stat-muted">{t("settings.workspaceStatus")}</div>
            </div>
